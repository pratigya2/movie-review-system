...
serieslist::serieslist(QString username_10,QWidget *parent) :
    QDialog(parent),
    username_10(username_10),
    ui(new Ui::serieslist)
{
    ui->setupUi(this);
    ...
    if (qry.exec())
    {
       ...
       ui->tableView->setModel(model);
       ui->tableView->resizeColumnsToContents();
       ui->tableView->setItemDelegateForColumn(0,new ImageDelegatedd);
...
//void serieslist::on_tableView_activated(const QModelIndex &index)
//{
...
//            temp_series = new series(username_10,this);
//            temp_series->show();
//            qDebug()<<"signal";
